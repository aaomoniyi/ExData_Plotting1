...
powerGA <- read.table("household_power_consumption.txt",skip=1,sep=";")
names(powerGA) <- c("Date","Time","Global_active_power","Global_reactive_power","Voltage","Global_intensity","Sub_metering_1","Sub_metering_2","Sub_metering_3")
subpower <- subset(powerGA,powerGA$Date=="1/2/2007" | powerGA$Date =="2/2/2007")
